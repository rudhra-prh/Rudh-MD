...
async function startMiku() {
    ...
    console.log(color(figlet.textSync('Rudhra Bot', {
        font: 'Pagga',
    ...
    console.log(color('\nThanks for using: RUDHRA MD made by princerudh.', 'aqua'))
    console.log(color('\nYou can follow me on GitHub: princerudh\n\n', 'aqua'))
    ...
    const Miku = MikuConnect({
        ...
        browser: ['Rudhra MD', 'Safari', '1.0.0'],
        auth: state,
        version
    })
    ...
    Miku.ev.on('connection.update', async (update) => {
        ...
        status = connection;
        if (connection) {
            await console.info(`Rudhra MD Server Status => ${connection}`);
          }
